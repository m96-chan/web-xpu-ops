...
const EXAMPLES_TESTED = ["examples/zimage/src", "examples/zimage-vae/src", "examples/anima/src", "examples/anima-web/src", "examples/web-common/src", "examples/zimage-web/src", "examples/h3-audio/src", "examples/h3-audio-web/src", "examples/h3-video/src", "examples/h3-video-web/src", "examples/h3-dit/src"];
