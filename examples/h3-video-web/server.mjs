#!/usr/bin/env node
/**
 * A static server for the MiniMax-H3 video-decoder demo that answers `Range`.
 *
 ...
 * of those with the whole 9.69 GB file.
 *
 *     node examples/h3-video-web/server.mjs --weights ~/h3-video-web
 *
 * `--weights` is a directory `examples/h3-video/tools/convert_decoder.py` wrote.
 */
